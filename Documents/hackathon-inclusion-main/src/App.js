...
import CreativeRegistration from './components/CreativeRegistration';
import FieldAgentRegistration from './components/FieldAgentRegistration';
        ...
        <Router>
          <div className="App">
            ...
            <Routes>
              ...
              <Route path="/register/creative" element={<CreativeRegistration />} />
              <Route path="/register/field-agent" element={<FieldAgentRegistration />} />
              <Route path="/register/admin" element={<AdminRegistration />} />
              <Route path="/user-selector" element={<UserTypeSelector />} />
              ...
              {/* PWD Dashboard Routes */}
              <Route path="/pwd/dashboard" element={
                <ProtectedRoute requiredRole="creative">
                  <PWDDashboard />
                </ProtectedRoute>
              } />
              
              {/* Refugee Dashboard Routes */}
              <Route path="/refugee/dashboard" element={
                <ProtectedRoute requiredRole="creative">
                  <RefugeeDashboard />
                </ProtectedRoute>
              } />
